...
namespace dbServer
{
    public class Server
	{
        ...
        private static string getData(Socket socket, int size)
        {
            ...
            return toString(bb, k).ToLower(); //.ToLower() keeps single columns from returning blank due to capitalization error
        ...
        public void startServer()
        {
            ...
            try
            {
                ...
                TcpListener myList = new TcpListener(ipAd, FreeTcpPort());
